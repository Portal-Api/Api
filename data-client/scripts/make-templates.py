...
import codecs
import requests
from import Environment, FileSystemLoader
...
chain(
    ...
    populate_main_pages,
    postprocess_wikis,
    render_template(u"basichash.java", u"SpecialAliasData", key=u"special_alias"),
    render_template(u"basichash.java", u"FileAliasData", key=u"file_alias"),
    render_template(u"basichash.java", u"MainPageNameData", key=u"main_page_name"),
)
